...
// Input Schema
export const UpdateFieldForDatasetInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "PUT", path: "/v2/datasets/{dataset_id}/fields/{field_id}" }));
export type UpdateFieldForDatasetInput = typeof UpdateFieldForDatasetInput.Type;

// Output Schema
export const UpdateFieldForDatasetOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({
  description: Schema.optional(Schema.String),
  hidden: Schema.optional(Schema.Boolean),
  name: Schema.String,
  type: Schema.String,
...
export type UpdateFieldForDatasetOutput = typeof UpdateFieldForDatasetOutput.Type;
