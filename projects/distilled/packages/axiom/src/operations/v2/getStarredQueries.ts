...
// Output Schema
export const GetStarredQueriesOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
  dataset: Schema.optional(Schema.String),
  ...
  query: Schema.Struct({
    ...
    queryOptions: Schema.optional(Schema.Struct({
      ...
      timeSeriesView: Schema.optional(Schema.Literals(["charts", "resultsTable", "charts|resultsTable", ""])),
    })),
