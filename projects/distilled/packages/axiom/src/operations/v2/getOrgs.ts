...
// Input Schema
export const GetOrgsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({

}).pipe(T.Http({ method: "GET", path: "/v2/orgs" }));
export type GetOrgsInput = typeof GetOrgsInput.Type;

// Output Schema
export const GetOrgsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
  ...
  license: Schema.Struct({
    ...
    tier: Schema.Literals(["personal", "basicDirect", "teamMonthlyDirect", "teamMonthlyAws", "axiomCloud", "teamPlus", "enterprise", "comped"]),
  ...
  plan: Schema.Literals(["personal", "basicDirect", "teamMonthlyDirect", "teamMonthlyAws", "axiomCloud", "teamPlus", "enterprise", "comped"]),
