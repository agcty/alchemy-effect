...
// Input Schema
export const GetViewsInput = /*@__PURE__*/ /*#__PURE__*/ Schema.Struct({

}).pipe(T.Http({ method: "GET", path: "/v2/views" }));
export type GetViewsInput = typeof GetViewsInput.Type;

// Output Schema
export const GetViewsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
