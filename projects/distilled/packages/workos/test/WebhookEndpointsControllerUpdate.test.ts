...
describe("WebhookEndpointsControllerUpdate", () => {
  it("updates a webhook endpoint, then cleans up", async () => {
  ...
  it("fails with NotFound for a non-existent endpoint id", async () => {
  ...
  it("fails with a typed Conflict when changing the endpoint_url to one already registered", async () => {
  ...
  it("fails with UnprocessableEntity for a malformed endpoint_url update", async () => {
