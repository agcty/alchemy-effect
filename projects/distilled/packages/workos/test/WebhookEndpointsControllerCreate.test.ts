...
describe("WebhookEndpointsControllerCreate", () => {
  it("creates a webhook endpoint, then cleans up", async () => {
  ...
  it("fails with a typed Conflict when the endpoint url is already registered", async () => {
  ...
  it("fails with UnprocessableEntity for a malformed endpoint url", async () => {
