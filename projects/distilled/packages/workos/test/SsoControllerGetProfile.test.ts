...
describe("SsoControllerGetProfile", () => {
  it("returns a profile or fails with NotFound when no access token is associated with the request", async () => {
  ...
  it("fails with NotFound when called without a valid SSO access token", async () => {
