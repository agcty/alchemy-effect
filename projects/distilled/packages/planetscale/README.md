# @oddlynew/distilled-planetscale
...
```bash
npm install @oddlynew/distilled-planetscale effect
```
...
import { listDatabases } from "@oddlynew/distilled-planetscale/Operations";
import {
  CredentialsFromEnv,
  Credentials,
} from "@oddlynew/distilled-planetscale";
...
```typescript
import { getDatabase } from "@oddlynew/distilled-planetscale/Operations";
