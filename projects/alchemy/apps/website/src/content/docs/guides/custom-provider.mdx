...
// src/stripe/Product.ts
+import { Resource } from "@oddlynew/alchemy";
+
export interface StripeProductProps {
  name: string;
  description?: string;
...
// src/stripe/Product.ts
-import { Resource } from "@oddlynew/alchemy";
+import * as Provider from "@oddlynew/alchemy/Provider";
+import { Resource } from "@oddlynew/alchemy";
...
```diff lang="typescript"
+import { isResolved } from "@oddlynew/alchemy/Diff";
+
// ...
...
```typescript
import { Unowned } from "@oddlynew/alchemy/AdoptPolicy";
...
+} from "@oddlynew/alchemy/Auth/AuthProvider";
+import {
+  deleteCredentials,
+  displayRedacted,
+  readCredentials,
+  writeCredentials,
+} from "@oddlynew/alchemy/Auth/Credentials";
+import { getEnvRedacted, retryOnce } from "@oddlynew/alchemy/Auth/Env";
+import * as Clank from "@oddlynew/alchemy/Util/Clank";
...
import { getAuthProvider } from "@oddlynew/alchemy/Auth/AuthProvider";
import { ALCHEMY_PROFILE, Profile } from "@oddlynew/alchemy/Auth/Profile";
import {
  STRIPE_AUTH_PROVIDER_NAME,
