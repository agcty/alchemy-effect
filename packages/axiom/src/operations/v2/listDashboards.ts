...
// Output Schema
export const ListDashboardsOutput = /*@__PURE__*/ /*#__PURE__*/ Schema.Array(Schema.Struct({
  ...
  dashboard: Schema.Struct({
    ...
    against: Schema.optional(Schema.Literals(["-1h", "-3h", "-6h", "-12h", "-1d", "-3d", "-7d", "-1w", "-2w", "-3w", "-30d", "-60d", "-90d"])),
